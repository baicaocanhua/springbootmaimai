package com.maimai.openoffice.controller.DrawFromExcel;
...
public class DrawFromExcel2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Workbook wb = WorkbookFactory.create(new File("d:/111/23232323.xlsx"));
...
//                    case CellType.FORMULA:
            ...
            g2d.dispose();
            ImageIO.write(image, "png", new File("d:/test_"+sheet.getSheetName()+".png"));
            //#endregion
        }
        wb.close();
    ...
    public static void convert(Sheet sheet, String path) {
